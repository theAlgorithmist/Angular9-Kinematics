...
/**
 * Manager class for a simple Biped Hand (finger links not currently used for simple 2D characters - this is deferred
 * to a future implementation).  The (biped) right *must* supply a template for the hand.
 */
...
export class Hand extends Connector
{
  constructor(
    g: IGraphics,
    x: number,
  ...
  )
  {
    ...
    this.NAME    = type === BONE_PROPS.LEFT ? "L_Hand" : "R_Hand";
