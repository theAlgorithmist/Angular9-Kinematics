...
/**
 * Manager class for a Biped Head (with optional terminators to place two antennae).  The (biped) rig
 * *must* supply a drawing Template for the head.
 * 
...
export class Head extends Connector
{
