...
import { IPoint } from './IPlanarCurve';
 ...
 * @default 0.00001
 *
 * @returns {IPoint} contains solution values or zero-vector if determinant is less than or equal to zero tolerance
 * 
 * @author Jim Armstrong (www.algorithmist.net)
 *
 * @version 1.0
 */
export const solve2x2 = (a11: number,
                         a12: number,
                         a21: number,
                         a22: number,
                         b1: number,
                         b2: number,
                         zeroTol: number = 0.0001): IPoint => {
