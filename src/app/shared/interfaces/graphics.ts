 ...
 * EaselJS or PIXI JS, but mostly for the latter)
 *
...
export interface IGraphics
{
  ...
  lineStyle(strokeWidth: number, strokeColor: string | number, alpha?: number);
  ...
  bezierCurveTo(cx: number, cy: number, cx1: number, cy1: number, x1: number, y1: number);
}
